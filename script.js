...
const translations = {
  fr: {
    ...
    "project.mood.desc":   "Un projet en HTML, CSS et JS qui permet de suivre son humeur au fil du temps. Fait en en éval de fin d'année, sur JS et le DOM",
  ...
  en: {
    ...
    "project.mood.desc":   "An HTML, CSS & JS project that tracks your mood over time. Built as a final year evaluation, using JS and the DOM.",
