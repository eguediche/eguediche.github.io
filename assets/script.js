...
var projects = {
  projet1: {
    ...
    live:    "#",       // lien live (github pages ou autre)
...
var translations = {
  fr: {
    ...
    "about.text":         "",                    // ma description en français
    "tab.projects":       "Projets",
    "tab.contacts":       "Contacts",
    "tab.skills":         "Compétences",
    "nav.hint":           "← → pour changer d'onglet",
    "project.clickable":  "👆 cliquer moi",
    "project.projet1.desc": "",                  // description projet 1 en FR
    "project.projet2.desc": "",                  // description projet 2 en FR
  ...
  en: {
    ...
    "about.text":         "",                    // ma description en anglais
    "tab.projects":       "Projects",
    "tab.contacts":       "Contacts",
    "tab.skills":         "Skills",
    "nav.hint":           "← → to switch tabs",
    "project.clickable":  "👆 click me",
    "project.projet1.desc": "",                  // description projet 1 en EN
    "project.projet2.desc": "",                  // description projet 2 en EN
...
function applyLanguage(lang) {
  ...
  if (lang === "fr") {
    flag.src = "assets/flag-en.png";
    flag.alt = "Switch to English";
    if (badge) badge.textContent = "EN";
  } else {
    flag.src = "assets/flag-fr.png";
    flag.alt = "Passer en Français";
    if (badge) badge.textContent = "FR";
  }
}

// clic sur le drapeau pour switcher
document.getElementById("lang-flag").addEventListener("click", function() {
